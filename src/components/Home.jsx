    ...
    <main>
      <section className="text-sections">
        ...
        <div className="instructions">
          ...
          <h2>
            VHS TAPES (1–3) ARE SCATTERED ACROSS THE CITY. EACH TAPE CONTAINS A DIFFERENT PART OF THE 
            PASSWORD. ONCE YOU'VE FOUND ALL THREE, ENTER THE FULL PASSWORD IN THE LOCKBOX TAB TO UNLOCK THE 
            COORDINATES OF WHERE I BURIED IT LONG AGO. I'LL SHARE DETAILS FOR EACH TAPE LOCATION TO THE BEST OF MY MEMORY. FIND THEM ALL, 
